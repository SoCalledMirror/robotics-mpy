...
Thank you for&nbsp;your interest in&nbsp;contributing to&nbsp;the&nbsp;[SoCalled Robotics (MicroPython)](README.md) project!

⚠️ First, read the&nbsp;[general contribution guide for&nbsp;the&nbsp;SoCalled community](https://socalled.link/community/CONTRIBUTING.md).
...
Create or&nbsp;update examples to&nbsp;demonstrate new functionality.
Before submitting a&nbsp;pull request,
__ensure__ that all existing examples run on&nbsp;the&nbsp;target devices.
...
*	__Line length.__  
	...
	Up&nbsp;to&nbsp;120&nbsp;characters is&nbsp;allowed if&nbsp;it&nbsp;improves readability.
*	__Spacing.__  
...
Use __Google‑style docstrings__ in&nbsp;English
for&nbsp;all public modules, classes, functions, and methods.

Required elements for&nbsp;a&nbsp;method or&nbsp;a&nbsp;function:

*	Brief description of&nbsp;purpose.
*	__Args__ is&nbsp;a&nbsp;list of&nbsp;arguments with type and&nbsp;purpose.
*	__Returns__ is&nbsp;a&nbsp;description of&nbsp;the&nbsp;return value, including type.
*	__Raises__ is&nbsp;list of&nbsp;xceptions that may&nbsp;be&nbsp;raised, with conditions.
...
*	Place the&nbsp;comment above the&nbsp;explained block, starting with a&nbsp;capital letter.
...
as&nbsp;well as&nbsp;project‑specific component labels are&nbsp;used for&nbsp;task categorization.
...
|:--                |:--                   |:--
| __Actuators__     | Actuator control     | __socalled/servo.py__, __socalled/servo_controller.py__
| __Core__          | Core changes         | __socalled/timer.py__, __socalled/event_loop.py__
| __Documentation__ | Documentation        | __README.md__, __doc/*__
| __Examples__      | Usage examples       | __examples/brightness_controller.py__
| __Input__         | Input handling       | __socalled/button.py__
| __Sensors__       | Working with sensors | __socalled/digital_sensor__, __socalled/hcsr04_sensor__

<a name="licensing"></a>
## Licensing and Copyright

__Source code__ is&nbsp;distributed
under the&nbsp;__[Mozilla Public License&nbsp;2.0 (MPL‑2.0)](https://socalled.link/community/LICENSE_MPL-2.0.md)__ license.
...
under the&nbsp;__[Creative Commons Attribution&nbsp;4.0 International (CC‑BY‑4.0)](https://socalled.link/community/LICENSE_CC-BY-4.0.md)__ license.
